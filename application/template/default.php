          ...
          <ul class="nav navbar-nav">
            ...
            ?>
              <li <?php if ($class == 'request' || $class == 'wares') {
                echo 'class="active"';
              }?>><a href=<?php echo base_url() . 'request/fillrequest';?>>Créer une demande</a></li>
            <?php
            }
            else {
            ?>
              <li <?php if ($class == 'auth' && $method == 'login') {
                echo 'class="active"';
              }?>><a href=<?php echo base_url() . 'auth'; ?>>Se connecter</a></li>
          ...
          <?php
            if($is_logged) {
              ...
              <ul class="nav navbar-nav navbar-right">
                <li><a href=<?php echo base_url() . 'auth/logout'; ?>>Se déconnecter</a></li>
              </ul>
              <?php
            }
          ?>
